...
import { FileSpreadsheet, FileText, FileType, Download, Users, DollarSign, FileCheck2, Ticket, TrendingUp } from "lucide-react";
...
const relatorios = [
  { nome: "Base de Clientes", desc: "Lista completa com status, MRR e responsável", icon: Users, ult: "Gerado há 2h" },
  { nome: "Financeiro Mensal", desc: "Recebimentos, inadimplência, renovações e cancelamentos", icon: DollarSign, ult: "Gerado ontem" },
  { nome: "Gestão SICAF", desc: "Níveis I a VI, vencimentos e pendências", icon: FileCheck2, ult: "Hoje 09:00" },
  { nome: "Suporte e SLA", desc: "Tickets resolvidos, tempo médio, NPS", icon: Ticket, ult: "Semanal · seg 08:00" },
  { nome: "Google Ads", desc: "Palavras, ROAS, CPA, atribuição por cliente", icon: TrendingUp, ult: "Diário · 06:00" },
];
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      <div className="mb-6 flex flex-wrap items-end justify-between gap-3">
        ...
        <Button variant="outline" size="sm">Agendar envio</Button>
      </div>
